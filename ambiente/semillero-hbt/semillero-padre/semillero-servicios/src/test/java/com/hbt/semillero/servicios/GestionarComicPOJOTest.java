...
public class GestionarComicPOJOTest {
	...
	public void crearComicDTOTest() {
		...
		comicDTO.setNumeroDePaginas(128);
		comicDTO.setPrecio(new BigDecimal(5000));
		comicDTO.setAutor("Phillippe Briones, Roger Stern");
		...
		comicDTO.setNumeroDePaginas(208);
		comicDTO.setPrecio(new BigDecimal(6225));
		comicDTO.setAutor("Straczynski,Deodato Jr.,Barnes,Eaton");
		comicDTO.setColores(Boolean.TRUE);
		comicDTO.setFechaVenta(LocalDate.now());
